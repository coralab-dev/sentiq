...
export function RestaurantsListClient() {
  ...
  if (status === "error") return <EmptyState title="No se pudieron cargar los restaurantes" description="Verifica tu conexion e intenta nuevamente." icon={<AlertTriangle className="size-6" />} action={<Button onClick={() => void load()}><RefreshCw />Reintentar</Button>} />;
